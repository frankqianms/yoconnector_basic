...
/**
 * Implementation of the yoconnectorBasicConnector Connector connect page
 */
export const YoconnectorBasicConnectorConfig = () => {
        ...
        if (context) {
            pages.config.registerOnSaveHandler((saveEvent: pages.config.SaveEvent) => {
                const settings: any = {
                    ...
                    contentUrl: `https://${process.env.PUBLIC_HOSTNAME}/yoconnectorBasicConnector/config.html?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}`,
